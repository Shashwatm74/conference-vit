            ...
            <section className={styles.login}>
                <div className={styles.login_container}>
                    <div className={styles.signup_card_wrapper}>
                        <div><span className={styles.span_heading}>Sign Up</span></div>
                        <div>Name</div>
                        <input className={styles.input_box} placeholder='Enter first name...' required type="text" />
                        <input className={styles.input_box} placeholder='Enter last name...' required type="text" />
                        <div>Email</div>
                        <input className={styles.input_box} placeholder='Enter email...' required type="email" />
                        <div>User Name</div>
